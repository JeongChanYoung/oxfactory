...
// <![CDATA[
	function upload() {
		document.image_upload.uploadImg
	...
	function done() {
		...
		var _mockdata = {
			'imageurl': '${pageContext.request.contextPath}${requestScope.i_path}',
 			'filename': '${requestScope.i_original}',
		...
		_mockdata.imageurl = encodeURI(_mockdata.imageurl); //이건 자바스크립트고 jsp꺼
		//_mockdata.filename = encodeURI(_mockdata.filename);
		_mockdata.originalurl = encodeURI(_mockdata.originalurl);
		_mockdata.thumburl = encodeURI(_mockdata.thumburl);
		...
		<c:otherwise>
			<div class="body">
				<dl class="alert">
				    <dt>파일 첨부 확인</dt>
				    <dd>
				    	확인을 누르시면 <b>"${requestScope.i_original}"</b> 가 파일첨부 됩니다.<br /> 
					</dd>
				</dl>
			</div>
			<div class="footer">
