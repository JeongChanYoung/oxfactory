...
if( $_POST['uploaded'] == 'upload_now' && !$_FILES['image_file']['error'] ) { 
  ...
  move_uploaded_file($_FILES['image_file']['tmp_name'] , '../../../upload/' . $file_name ) ;
	
  
  $imageurl = 'http://' . $_SERVER['HTTP_HOST'] . '/oxfactory/upload/' . $file_name ;
...
?>
	...
	<div class="body">
		<dl class="alert">
		    <dt>사진 첨부 확인</dt>
		    <dd>
		    	확인을 누르시면 <b>"<?=$file_org_name;?>"</b> 가 사진첨부 됩니다.<br /> 
			</dd>
		</dl>
	</div>
	<div class="footer">
