...
<%
	...
	String saveFolder = "FileFolder";//이미지 파일 저장폴더
	...
	try { 
		...
		//
		File newFile = multi.getFile("uploadFile");
		//newFile.renameTo(new File(java.net.URLEncoder.encode(multi.getOriginalFileName("uploadImg"))));
		String newName = java.net.URLEncoder.encode(multi.getFilesystemName("uploadFile"),"UTF-8");
