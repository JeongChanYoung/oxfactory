...
#                                                                          # 
$to = "redhotjjang@naver.com"; #set addres to send for to 
...
$location = "https://www.oxfactory.net:41996/oxfactory/views/test_view.php"; #set page to redirect to, if 1 is above 
#                                                                          # 
